...
goog.exportSymbol('proto.core.CommunicationStatus', null, global);
 ...
 * @constructor
 */
proto.core.CommunicationStatus = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.core.CommunicationStatus.repeatedFields_, null);
};
goog.inherits(proto.core.CommunicationStatus, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.core.CommunicationStatus.displayName = 'proto.core.CommunicationStatus';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.core.CommunicationStatus.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.core.CommunicationStatus.prototype.toObject = function(opt_includeInstance) {
  return proto.core.CommunicationStatus.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.core.CommunicationStatus} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.core.CommunicationStatus.toObject = function(includeInstance, msg) {
  var f, obj = {
    websocketConnectionsList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.core.CommunicationStatus}
 */
proto.core.CommunicationStatus.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.core.CommunicationStatus;
  return proto.core.CommunicationStatus.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.core.CommunicationStatus} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.core.CommunicationStatus}
 */
proto.core.CommunicationStatus.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {string} */ (reader.readString());
      msg.addWebsocketConnections(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.core.CommunicationStatus.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.core.CommunicationStatus.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.core.CommunicationStatus} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.core.CommunicationStatus.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWebsocketConnectionsList();
  if (f.length > 0) {
...
/**
 * repeated string websocket_connections = 1;
 * @return {!Array<string>}
 */
proto.core.CommunicationStatus.prototype.getWebsocketConnectionsList = function() {
 ...
 * @return {!proto.core.CommunicationStatus} returns this
 */
proto.core.CommunicationStatus.prototype.setWebsocketConnectionsList = function(value) {
 ...
 * @return {!proto.core.CommunicationStatus} returns this
 */
proto.core.CommunicationStatus.prototype.addWebsocketConnections = function(value, opt_index) {
 ...
 * @return {!proto.core.CommunicationStatus} returns this
 */
proto.core.CommunicationStatus.prototype.clearWebsocketConnectionsList = function() {
  return this.setWebsocketConnectionsList([]);
};
...
proto.core.StatusResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    communicationStatus: (f = msg.getCommunicationStatus()) && proto.core.CommunicationStatus.toObject(includeInstance, f)
  };
...
proto.core.StatusResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.core.CommunicationStatus;
      reader.readMessage(value,proto.core.CommunicationStatus.deserializeBinaryFromReader);
      msg.setCommunicationStatus(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.core.StatusResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getCommunicationStatus();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.core.CommunicationStatus.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional CommunicationStatus communication_status = 3;
 * @return {?proto.core.CommunicationStatus}
 */
proto.core.StatusResponse.prototype.getCommunicationStatus = function() {
  return /** @type{?proto.core.CommunicationStatus} */ (
    jspb.Message.getWrapperField(this, proto.core.CommunicationStatus, 3));
};


/**
 * @param {?proto.core.CommunicationStatus|undefined} value
 * @return {!proto.core.StatusResponse} returns this
*/
proto.core.StatusResponse.prototype.setCommunicationStatus = function(value) {
 ...
 * @return {!proto.core.StatusResponse} returns this
 */
proto.core.StatusResponse.prototype.clearCommunicationStatus = function() {
  return this.setCommunicationStatus(undefined);
};
 ...
 * @return {boolean}
 */
proto.core.StatusResponse.prototype.hasCommunicationStatus = function() {
