...
// Source: github.com/imperviousai/freeimp/core (interfaces: Core)
...
import (
	...
	config "github.com/imperviousai/freeimp/config"
	contacts "github.com/imperviousai/freeimp/contacts"
	id "github.com/imperviousai/freeimp/id"
	messages "github.com/imperviousai/freeimp/messages"
	relay "github.com/imperviousai/freeimp/service/relay"
)
...
func (m *MockCore) InitSeed(arg0, arg1 string) (string, error) {
	m.ctrl.T.Helper()
