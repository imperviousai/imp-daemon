...
export default function FileUploadConfirm({
  open,
  setOpen,
  setShowAlert,
  displayAlert,
                ...
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Do you want to upload files to your Impervious node? This
                      will not go to a cloud provider and Impervious will not
                      have access these files.
                    </p>
                  </div>
                </div>
              </div>
              <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                <button
                  ...
                  onClick={() => {
                    setOpen(false);
                    displayAlert(
                      "Files have been successfully uploaded to IPFS."
                    );
                  }}
                  // TODO: Upload your files to IPFS
                >
                  Upload
                </button>
                <button
